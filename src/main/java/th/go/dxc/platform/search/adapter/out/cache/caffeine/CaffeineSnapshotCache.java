package th.go.dxc.platform.search.adapter.out.cache.caffeine;
...
@Slf4j
public final class CaffeineSnapshotCache implements SnapshotCachePort {
  private final com.github.benmanes.caffeine.cache.Cache<String, ReportDataSnapshot> cache;
  private final String ver, ns;

  public CaffeineSnapshotCache(ReportProperties.Snapshot cfg) {
