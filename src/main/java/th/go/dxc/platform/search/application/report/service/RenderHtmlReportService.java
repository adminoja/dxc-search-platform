...
@Slf4j
@Service
public class RenderHtmlReportService implements RenderHtmlReportUseCase {
    private static final Duration IO_TIMEOUT = Duration.ofSeconds(5);
    private final DatasetRepository datasetRepository;
    private final TemplateIO io;
    private final ReportDataSnapshotStorePort snapshots;
    ...
    public Mono<Output> execute(Input input) {
        ...
        return Mono.fromCallable(() -> {
            ...
            model.put("doc", snap.dataAsMap());
            model.put("raw", snap.data());
            // model.put("thai", thai);
